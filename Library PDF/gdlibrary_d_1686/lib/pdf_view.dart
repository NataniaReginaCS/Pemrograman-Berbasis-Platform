...
import 'package:gdlibrary_d_1686/invoice/get_total_invoice.dart';
import 'package:gdlibrary_d_1686/invoice/model/custom_row_invoice.dart';
import 'package:gdlibrary_d_1686/invoice/model/product.dart';
import 'package:barcode_widget/barcode_widget.dart';
import 'package:gdlibrary_d_1686/preview_screen.dart';
import 'package:gdlibrary_d_1686/invoice/item_doc.dart';
...
Future<void> createPdf(
  ...
  doc.addPage(
            ...
            child: pw.Column(
              ...
              pw.Container(
                  margin: pw.EdgeInsets.symmetric(
                      horizontal: 2.h, vertical: 2.h)), // pw. EdgeInsets.symmetric // pw.Container
    ...
    footer: (pw.Context context) {
      return pw.Container(
            color: PdfColor.fromHex('#FFBD59'),
            child: footerPDF(formattedDate)); // pw.Container
      },
    ), // pw.MultiPage
  );
...
pw.Padding imageFromInput(
    pw.ImageProvider Function(Uint8List imageBytes) pdfImageProvider, Uint8List imageBytes) {
      return pw.Padding(
